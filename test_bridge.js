...
// //     console.log("Hands off the mouse! Automated test starting in 3 seconds...");
...
if (isStarted) {
    ...
    setTimeout(async () => {
        ...
        // ==========================================
            ...
            console.log("Running Windows Virtual Touchscreen sequence...");
            ...
            // Windows Touch Panning (Scroll)
            console.log("[TEST 3] Touch Panning (Scroll) via InjectTouchInput...");
            let pan_y = 500;
            virtualTrackpad.sendTouch(0, 100, 500, pan_y); // Finger hits the glass
            virtualTrackpad.sync();

            for(let i = 0; i < 20; i++) {
                    await new Promise(r => setTimeout(r, 20)); 
                    pan_y -= 10; // Drag finger UP to scroll page DOWN
                    virtualTrackpad.sendTouch(0, 100, 500, pan_y);
                    virtualTrackpad.sync();
            }

            virtualTrackpad.sendTouch(0, -1, 500, pan_y); // Finger lifts off
            virtualTrackpad.sync();

            await new Promise(r => setTimeout(r, 500));

            // Windows Native Pinch-to-Zoom
            ...
            console.log("✅ Windows Virtual Touchscreen sequence complete!");
        }
